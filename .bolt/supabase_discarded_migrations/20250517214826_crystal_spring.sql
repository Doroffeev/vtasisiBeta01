/*
  ...
  2. Функции и триггеры
    - Функции для синхронизации данных между таблицами
...
-- Создаем триггеры только после того, как таблица animals будет создана
-- Отложим создание триггеров до следующей миграции, чтобы избежать ошибок