/*
  # Создание таблиц для модуля плановых ветеринарных операций

  1. Новые таблицы
    - `operation_templates` - шаблоны плановых операций
    - `operation_steps` - шаги в шаблонах операций
    - `assigned_plans` - назначенные животным планы
    - `scheduled_operations` - запланированные операции

  2. Индексы
    - Созданы индексы для всех внешних ключей
    - Индексы для полей с фильтрами (дата, статус)

  3. Политики безопасности
    - Настроены RLS политики для всех таблиц
    - Разграничены права на создание, просмотр, редактирование
*/
