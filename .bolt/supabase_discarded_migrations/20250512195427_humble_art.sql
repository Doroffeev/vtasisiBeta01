/*
  ...
  1. Changes:
    - Drop all existing policies for the users table to avoid conflicts
    - Create new policies with proper checks
    - Ensure admin permissions are properly enforced
    - Fix specific insert, update and delete policies

  2. Security:
    - Make sure only admins can add users
